...
<?php get_header(); ?>
	...
	<?php get_sidebar(); ?>	
		...
		<a class="popup" href="<?php echo esc_url( home_url( '/' ) ); ?>macbookpro-retina/"><div class="thumb rightpad">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>products/mac/macbook-air"><div class="thumb">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>products/mac/mac-pro"><div class="thumb">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>products/mac/mac-mini"><div class="thumb rightpad">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>products/mac/displays"><div class="thumb">
