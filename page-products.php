...
<?php get_header(); ?>
	...
	<?php get_sidebar(); ?>	
		...
		<a href="http://imaginestore.org/products/mac"><div class="thumb rightpad">
		<p><strong>Mac</strong>The complete Mac range.</p>
		<img src="<?php bloginfo('template_url');?>/images/products/thumb-mac.jpg" alt="Mac" >
		</div></a>
		<a href="http://imaginestore.org/products/ipod"><div class="thumb">
		...
		<a href="http://imaginestore.org/products/iphone"><div class="thumb rightpad">
		...
		<a href="http://imaginestore.org/products/ipad"><div class="thumb">
		<p><strong>iPad</strong>Your sleek performer.</p>
		<img src="<?php bloginfo('template_url');?>/images/products/thumb-ipad.jpg" alt="iPad">
		</div></a>
<div class="clear"></div>
		<a href="http://imaginestore.org/products/applications"><div class="thumb rightpad">
		...
		<a href="http://imaginestore.org/accessory-catalogue/" target="_blank"><div class="thumb">
